...
namespace dspkit::easing {
    ...
    static const std::string function_info[] = {"linear",

                                                "in_back", "in_bounce", "in_circular", "in_cubic", "in_elastic",
                                                "in_exponential", "in_quadratic", "in_quartic", "in_quintic",
                                                "in_sine",

                                                "in_out_back", "in_out_bounce", "in_out_circular", "in_out_cubic",
                                                "in_out_elastic", "in_out_exponential", "in_out_quadratic",
                                                "in_out_quartic", "in_out_quintic", "in_out_sine",

                                                "out_back", "out_bounce", "out_circular", "out_cubic", "out_elastic",
                                                "out_exponential", "out_quadratic", "out_quartic",
    ...
    /// @tparam	T		The type of number to use for the calculations (e.g. float, double, number, or sample).
    /// @param	shape	The easing function to apply as enumerated in the #easing::function enum.
    ///	@param	x		The value to feed as input into the easing function.
    ///	@return			The "eased" output.

    template<typename T>
    T apply(easing::function shape, T x) {
        switch (shape) {
    ...
    /// get a reference to an easing function
    /// @tparam	T		The type of number to use for the calculations (e.g. float, double, number, or sample).
    /// @param	shape	The easing function to get as enumerated in the #easing::function enum.
